...
# 示例2: JSON格式配置，包含名称、URL、描述、图标和排序顺序
# 图标可以使用Bootstrap图标类名，完整图标列表: https://icons.getbootstrap.com/
# order字段决定了卡片的显示顺序，数字越小越靠前
export adspower='{
  "name": "AdsPower浏览器",
  "url": "https://share.adspower.net/WilliamSays",
  "description": "专业指纹浏览器，帮助您轻松应对各种指纹识别",
  "icon": "https://assets.website-files.com/636ab4193f0d3fa7c1fc0a4a/636e493fe0a0e21ea337ff0e_Logo.svg",
...
export kookeey='{
  ...
  "icon": "https://www.kookeey.com/favicon.ico",
  "order": 20
}'
